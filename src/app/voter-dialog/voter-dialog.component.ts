...
@Component({
  selector: 'app-voter-dialog',
  templateUrl: './voter-dialog.component.html',
  styleUrls: ['./voter-dialog.component.css']
})
export class VoterDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<VoterDialogComponent>,
    //@Optional() is used to prevent error if no data is passed
    @Optional() @Inject(MAT_DIALOG_DATA) public data: VoterEntity,
